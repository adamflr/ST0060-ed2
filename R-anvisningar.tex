...
Använd en chatbot (såsom Microsofts co-pilot eller OpenAIs ChatGPT) för att få kod som skapar en 3d-graf lik den vi skapade ovan. Se om det går att utveckla grafen ytterligare, t.ex. med en linje som går ner till grafen \emph{botten}, eller linjer som kopplar samma länder till kontinentens medelvärde.
\end{exercise}
...
## 
## data:  dat_sim$x
## t = -0.089831, df = 9, p-value = 0.9304
...
## $emmeans
##  group   emmean    SE df lower.CL upper.CL
##  a     -0.08672 0.306 45   -0.704    0.530
##  b     -0.33931 0.306 45   -0.956    0.278
##  c      0.08248 0.306 45   -0.534    0.699
##  d     -0.01765 0.306 45   -0.635    0.599
##  e      0.00479 0.306 45   -0.612    0.622
## 
## Confidence level used: 0.95 
## 
## $contrasts
##  contrast estimate    SE df t.ratio p.value
##  a - b      0.2526 0.433 45   0.583  0.5628
##  a - c     -0.1692 0.433 45  -0.391  0.6980
##  a - d     -0.0691 0.433 45  -0.159  0.8740
##  a - e     -0.0915 0.433 45  -0.211  0.8336
##  b - c     -0.4218 0.433 45  -0.974  0.3354
##  b - d     -0.3217 0.433 45  -0.743  0.4616
##  b - e     -0.3441 0.433 45  -0.794  0.4312
##  c - d      0.1001 0.433 45   0.231  0.8183
##  c - e      0.0777 0.433 45   0.179  0.8585
##  d - e     -0.0224 0.433 45  -0.052  0.9589
\end{verbatim}
