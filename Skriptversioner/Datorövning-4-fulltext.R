...
# större och på möjligheten att det är mindre.
#
...
# steg och jämföra med utskriften från `t.test()`.
#
...
# observerar är ganska sannolikt under nollhypotesen, vilket tyder på att nollhypotesen är rimligt.
#
